/**
 * The term-frequency data model represents the results for a unique set of search
 * parameters. The results for multiple searches can be accumulated as long as the query-string and
 ...
 * parameters.
 * 
 * @see com.aestheticsw.jobkeywords.domain.termfrequency.TermFrequencyResults
 * @see com.aestheticsw.jobkeywords.domain.termfrequency.SearchParameters
 * @see com.aestheticsw.jobkeywords.domain.termfrequency.QueryKey
 * 
